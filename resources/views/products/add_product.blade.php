...
@section('main-content')
    <div class="block-header" style="margin-left:15px;">
        <h2>
            Add New Product
            <small>Detailed and precise product information is more  effective  in encouraging  your potential customers to buy your products.</small>
            <small>You can save your work as Draft in each step and continue your work later.</small>
        </h2>
    </div>
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                @csrf
                    <div class="row" style="">
                        <h4 class="form-title">Product Information</h4>
                        <hr style="margin-left:10px; margin-right:10px;"/>
                        <div class="col-md-3" style="margin-top:0px;">
                            <div class="valid-info">
                                <h5>Product Category:</h5>
                                <select class="form-control" name="package" required>
                                    <option value="1">Tour Package</option>
                        ...
                        <div class="col-md-5" style="margin-top: 20px;">
                            <div class="valid-info">
                                <div class="open_info" id="open_info">
                                    <p><b><u>Open Trip</u></b></p>
                                    <small>Customers who booked  open trip product will go on the trip in group</small>
                                </div>
                                <div class="private_info" id="private_info" style="display:none;">
                                    <p><b><u>Private Trip</u></b></p>
                                    <small>Customers who booked  open trip product will go on the trip in group</small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6" style="margin-top: 10px;">
                            <div class="valid-info">
                                <h5>Product code:(Enter your product code if any.)</h5>
                    ...
                    <div class="row">
                        <div class="col-md-6" style="margin-top: 10px;">
                            <div class="valid-info">
                                <h5>Starting Point*:(Gathering point / Where should your customer meet you) </h5>
                                <input type="text" class="form-control"/>
                            </div>
                        </div>  
                        <div class="col-md-2">
                            <div class="valid-info">
                                <button class="form-control open_map">Open Map</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3" style="margin-top: 10px;">
                            <div class="valid-info">
                                ...
                                <input class="form-control unstyled" type="date">
                            </div>
                        </div>
                        <div class="col-md-3" style="margin-top: 10px;">
                            <div class="valid-info">
                                <h5>Ending Selling Date*:</h5>
                                <input class="form-control unstyled" type="date">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <h4 class="form-title">Duration & Schedule</h4>
                        <hr style="margin-left:10px; margin-right:10px;"/>  
                        <div class="col-md-10 mg-top-10px" style="margin-top:0px;">
                            <div class="valid-info">
                                <h5>How long  is the duration of the tour/activity ?*:</h5>
                                <div class="row">
                                    <form action="">
                                        <div class="col-md-3">
                                            <input name="company_ownership" type="radio" id="1o" class="radio-col-deep-orange" value="Company" required/>
                                            <label for="1o">Multiple days</label>
                                        </div>
                                        <div class="col-md-3">
                                            <input name="company_ownership" type="radio" id="2o" class="radio-col-deep-orange" value="Personal" required checked/>
                                            <label for="2o">A couple of hours</label>
                                        </div>
                                        <div class="col-md-3">
                                            <input name="company_ownership" type="radio" id="3o" class="radio-col-deep-orange" value="Personal" required checked/>
                                            <label for="3o">One day full</label>
                                        </div>
                                    </form>                         
                                </div>
                            ...
                            <div class="row" style="margin-top:10px;">
                                <div class="valid-info">
                                    <p>
                                       How many hours  will the tour/activity take place ?
                                    </p>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <select name="tour_hours" id="" class="form-control" style="" >
                        ...
                        <div class="col-md-10" style="margin-top: 10px;">
                            <div class="row valid-info">
                                <div class="col-md-12">
                                    <h5 style="margin-left:-15px;">Do you have existing booking system?</h5>
                                </div>
                                <div class="col-md-2">
                    ...
                    <div class="row">
                        <h4 class="form-title">Payment Data</h4>
                        <div class="col-md-3">
                            <div class="valid-info">
                                <h5>Bank Name*:</h5>
                    ...
                    <div class="row">
                        <h4 class="form-title">Upload Document</h4>
