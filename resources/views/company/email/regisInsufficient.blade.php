                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                                        <tr>
                                            <td align="left" style="padding-bottom: 30px;  font-size: 25px; font-family: Helvetica, Arial, sans-serif; color: #333333;" class="padding"><b>Registration Status Update</b></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr style="">                                           
                                            <td align="center" style="padding: 0px 0 0 0; font-size: 16px; line-height: 10px; font-family: Helvetica, Arial, sans-serif; color: #666666; background-color: lightgray;" class="padding">
                                                ...
                                                <p  style="text-decoration: underline;color: #E17306; font-size: 24px;">Insufficient Data</p>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="left" style="padding-top: 25px;" class="padding">
                                                <table border="0" cellspacing="0" cellpadding="0" class="mobile-button-container">
                                                    <tr>
                                                    	<td class="td-button bg-orange" align="center" style="border-radius: 5px; outline:none;" ><a href="http://tour.pigijo.id/login" target="_blank" style="font-size: 16px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 15px 25px; display: inline-block;" class="mobile-button">Login Now</a></td>
                                                    </tr>
                                                </table>
