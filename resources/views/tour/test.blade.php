                                    ...
                                    <div class="body">
                                        ...
                                        <div class="row" style="margin: 0px 3px 0px 3px;">
                                            <div class="col-md-3 valid-info">
                                                ...
                                                <input type="text" class="form-control" name="min_person" id="minPerson" value="{{$product->min_person}}"  required />
                                            </div>
                                            <div class="col-md-3 valid-info">
                                                <h5>Maximum Person*</h5>
                                                <input type="text" class="form-control" name="max_person" id="maxPerson" value="{{$product->max_person}}" required />    
                                            </div>
                                        </div>
                                        <div class="row" style="margin: 0px 3px 0px 3px;">
                                            <div class="col-md-6 valid-info">
                                        ...
                                        <div class="row" id="dinamic_destination" style="margin: 0px 3px 0px 3px;">
                                            ...
                                            <div class="col-md-4 valid-info">
                                                ...
                                                <select id="destinationField3" class="form-control" name="place[{{$key}}][destination]" style="width: 100%">
                                                    ...
                                                    <option value="{{$destination->destination_id}}" @if($product['destinations'][$key]['destination']['destination_id'] == $destination->destinationId) selected @endif>{{$destination->destination}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 valid-info">
                                                ...
                                                <select class="form-control" name="activity_tag[]" multiple="multiple" style="width: 100%">
                                                    @foreach($product->activities as $activity)
                                                        <option value="{{$activity->activity_id}}" selected="selected">{{$activity->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="body">
                                        <div class="row valid-info" style="margin: 0px 3px 0px 3px;">
                                            ...
                                            <div class="col-md-3" style="margin: 5px 3px 0px 3px;">
                                                <input name="schedule_type" type="radio" id="1d" class="radio-col-deep-orange" value="1" sel="1" disabled/>
                                                <label for="1d">Multiple days</label>
                                            </div>
                                            <div class="col-md-3" style="margin: 5px 3px 0px 3px;">
                                                <input name="schedule_type" type="radio" id="2d" class="radio-col-deep-orange" value="2" sel="2" disabled/>
                                                <label for="2d">A couple of hours</label>
                                            </div>
                                            <div class="col-md-3" style="margin: 5px 3px 0px 3px;">
                                                <input name="schedule_type" type="radio" id="3d" class="radio-col-deep-orange" value="3" sel="3" disabled/>
                                    ...
                                    <div id="itinerary_list" style="margin-left:15px;">
                                        ...
                                        <div class="row" id="itinerary_row">
                                            <div class="col-md-2 valid-info" id="field_itinerary1">
                                                <h5>Start time*</h5>
                                                <input id="field_itinerary_input2" type="text" class="form-control" name="itinerary[{{$key}}][list][0][startTime]" value="{{$iti->start_time}}" required />
                                            </div>
                                            <div class="col-md-2 valid-info" id="field_itinerary2">
                                                <h5>End time*</h5>
                                                <input id="field_itinerary_input3" type="text" class="form-control" name="itinerary[{{$key}}][list][0][endTime]" value="{{$iti->end_time}}" required/>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" id="price_list">
                                                ...
                                                @else
                                                    <div class="row">
                                                        <div class="col-md-1" style="padding: 20px 0px 0px 0px;">
                                                            <h5><i class="material-icons">person</i>1</h5>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-md-6 valid-info" id="price_idr">
                                                                    <h5>Price / person (IDR)*:</h5>
                                                                    <input id="price_list_field1" type="hidden" name="price[{{$key}}][people]" value="1" />  
                                                                    <input id="price_list_field2" type="text" class="form-control" name="price[{{$key}}][IDR]" value="{{$product->price_idr}}" />     
                                                                </div>
                                                                <div class="col-md-6 valid-info" id="price_usd" style="display: none">
                                                                    <h5>Price / person (USD)*:</h5>
                                                                    <input id="price_list_field3" type="text" class="form-control" name="price[{{$key}}][USD]" value="{{$product->price_usd}}" /> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row" id="cancel_policy" style="display: none;margin:0px">
                                            ...
                                            <div class="row" style="font-size: 14px;margin:0px">
                                                ...
                                                <div class="col-md-1 valid-info" style="margin:5px;padding:0px">
                                                    <input type="text" id="cancellationDay" name="min_cancel_day" class="form-control" value="{{$product->min_cancellation_day}}">
                                                </div>
                                                <div class="col-md-2" style="margin:5px;padding:0px;width:auto">
                                                    <h5>days from shcedule, cancellation fee is</h5>
                                                </div>
                                                <div class="col-md-1 valid-info" style="margin:5px;padding:0px">
                                                    <input type="text" id="cancellationFee" name="cancel_fee" class="form-control" value="{{$product->cancellation_fee}}">
                                                </div>
                                                <div class="col-md-2" style="margin:5px;padding:0px;width:auto">
                                                    <h5>percent(%)</h5>
                                                </div>
...
<!-- GMAP -->
    ...
    <script>
        ...
        // MASK
            ...
            $("#minPerson,#maxPerson,#cancellationDay,#cancellationFee").mask('0000');
        ...
        // PRICE
            ...
            var dbPriceKurs;
            var dbPriceType
            var dbPriIdr = '{{$product->price_idr}}';
            var dbPri = '{{$product->price_usd}}';
            var dbPritbIdr = '{{$product->prices[0]->price_idr}}';
            var dbPritb = '{{$product->prices[0]->price_usd}}';
            if(dbPri == null && dbPritb == null)    {
                dbPriceKurs = 'one';
            }else{
                dbPriceKurs = 'both';
            }
        ...
        // EDIT
            var dbCompany = '{{$product->company_id}}';
            var dbCat = '{{$product->product_category}}';
            var dbType = '{{$product->product_type}}';
            // COMPANY
            $("#company").find("option[value='"+dbCompany+"']").attr("selected","selected");
            // CATEGORY
            $("#productCategory").find("option[value='"+dbCat+"']").attr("selected","selected");
            // TYPE
            $("#productType").find("option[value='"+dbType+"']").attr("selected","selected");
            if(dbType == 'open'){
                $('#productTypeOpen').show();
                $('#productTypePrivate').hide();
                $("#schedule_body #scheduleCol6").find("h5").text("Max.Person*");
            ...
            // PIC PHONE
                ...
                $("#PICFormat").val(dbformat[0]);
                $("#PICPhone").val(dbformat[1]+'-'+dbformat[2]+'-'+dbformat[3]).intlTelInput({
                    separateDialCode: true,
                });    
            // ACTIVITY TAG
                $.ajax({
