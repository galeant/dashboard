    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                {{ Form::open(['url' => 'product/tour-activity', 'method' => 'post', 'id' => 'form-1', 'enctype' => 'multipart/form-data']) }}
                @csrf
                    <div class="row" >
                                    ...
                                    <div class="body">
                                        <div class="row" style="margin: 0px 3px 0px 3px;">
                                            <div class="col-md-6 valid-info" >
                                                <h5>Company</h5>
                                                {{ Form::select('company_id',['1' => 'Momo', '2' => 'lolo'], '1',['class'=> 'form-control']) }}
                                            </div>
                                        </div>
                                        <div class="row" style="margin: 0px 3px 0px 3px;">
                                            <div class="col-md-3 valid-info" >
                                                <h5>Product Category</h5>
                                                {{ Form::select('product_category',['1' => 'Activity'], '1',['class'=> 'form-control']) }}
                                            </div>
                                            <div class="col-md-3 valid-info">
                                                <h5>Type</h5>
                                                {{ Form::select('product_type',['1' => 'Open Group', '2' => 'Private Group'], '1',['class'=> 'form-control']) }}
                                            </div>
                                        ...
                                        <div class="row" style="margin: 0px 3px 0px 3px;">
                                            <div class="col-md-6 valid-info">
                                                <h5>Product Name*</h5>
                                                {{ Form::text('product_name','', ['class' => 'form-control', 'required' => 'required']) }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin: 0px 3px 0px 3px;">
                                            <div class="col-md-3 valid-info">
                                                ...
                                                {{ Form::text('min_person', '',['class' => 'form-control','id' => 'minPerson','required' => 'required' ]) }}
                                            </div>
                                            <div class="col-md-3 valid-info">
                                                <h5>Maximum Person*</h5>
                                                {{ Form::text('max_person', '',['class' => 'form-control','id' => 'minPerson','required' => 'required' ]) }}
                                            </div>
                                        </div>
                                        <div class="row" style="margin: 0px 3px 0px 3px;">
                                            <div class="col-md-6 valid-info">
                                                <h5>Starting Point/Gathering Point(where should your costumer meet you)?*</h5>
                                                {{ Form::text('meeting_point_address','', ['class' => 'form-control','id' => 'pac','place_holder'=> 'Start typing an address','required' => 'required' ]) }}
                                                {{ Form::hidden('meeting_point_latitude','', ['class' => 'form-control','id' => 'geo-lat']) }}
                                                {{ Form::hidden('meeting_point_longitude', '',['class' => 'form-control','id' => 'geo-long']) }}
                                            </div>
                                        </div>
                                        <div class="row" style="margin: 0px 3px 0px 3px;">
                                            <div class="col-md-6 valid-info">
