		        ...
		        <div class="body">
			        ...
			        <div class="row clearfix">
 						<div class="col-lg-8 m-l-30">
						        ...
						        {{ Form::model($data, ['route' => ['ucar.update', $data->id], 'method'=>'PUT', 'class'=>'form-horizontal','id'=>'form_advanced_validation']) }}
						    	<div class="form-group m-b-20">
					                <label>Model</label>
					                 {{ Form::text('model', null, ['class' => 'form-control','placeholder'=>'Please Enter Full Name','id'=>'name','readonly'=> 'readonly']) }}
					            </div>
								<div class="form-group m-b-20">
					                <label>Plat No</label>
					                 {{ Form::text('registration_number', null, ['class' => 'form-control','placeholder'=>'Please Enter Full Name','id'=>'name','readonly'=> 'readonly']) }}
					            </div>
								<div class="form-group m-b-20">
