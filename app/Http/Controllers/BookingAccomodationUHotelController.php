...
class BookingAccomodationUHotelController extends Controller
{
    /**
    ...
    public function index(Request $request){
        if($request->ajax())
        {
            $booking_hotel = BookingHotel::where('booking_from', 'uhotel')
        ...
        return view('bookings.accomodation-uhotel.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('bookings.accomodation-uhotel.detail',[
            'data' => $data
        ]);
    }
